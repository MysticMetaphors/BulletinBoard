                ...
                <div className="grid grid-row md:grid-cols-3 gap-5 justify-center px-0 lg:px-24">
                    {anno.map((annos) => (
                        <div className="max-w-90 p-6 pb-15 bg-white border border-gray-200 rounded-lg shadow-sm relative">
                            ...
                            <Link href={route(`announcement.show`, annos.id)} className="inline-flex absolute bottom-6 left-6 items-center py-2 text-sm font-medium text-center text-blue-500">
                                Read more
