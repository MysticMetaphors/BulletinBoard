...
export default function Announcement() {
    const { errors, anno } = usePage().props;
    const [content, setContent] = useState(anno.content);
    ...
    function handleSubmit(e) {
        e.preventDefault()
        router.put(route('announcement.update', anno.id), form, {
            onSuccess: (page) => {
    ...
    return (
        <>
            <div className="text-black p-4 pb-15 mt-12 h-full overflow-y-auto overflow-visible">
                <ol className="items-center w-full space-y-4 sm:flex sm:space-x-8 sm:space-y-0 rtl:space-x-reverse mb-4">
                    ...
                    >
                        ...
                        <span>
                            <h3 className="font-medium leading-tight">Editing Content</h3>
